  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center px-6 sm:px-8 md:px-12 bg-[#f8f8f8] mt-10 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mb-10">
        <button
          data-aos="fade-up"
          className="relative overflow-hidden group w-full sm:w-auto px-8 py-3 sm:py-4 border-2 border-[#333] bg-transparent text-[1rem] sm:text-[1.1rem] cursor-pointer transition-all duration-300 inline-flex items-center justify-center gap-2"
        >
